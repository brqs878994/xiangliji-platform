...
export default function PublishPage() {
  ...
  const reviewLabel = step === 1 ? '先看一眼草稿' : step === 2 && !draftId ? '保存草稿' : step === 2 ? '提交审核' : '已提交审核';

      ...
      <View className='main-content'>
        ...
        <View className='hero-grid'>
          <View className={`voice-card ${textMode ? 'typing-open' : ''}`}>
            ...
            <View className='voice-footer'><Text>✦ AI 会自动整理成信息</Text><View className='voice-footer-actions'><Text className='text-button' onClick={() => go('/pages/ai/index')}>问问 AI ↗</Text><View className='hero-publish-button' onClick={() => go('/pages/publish/index')}><Text className='publish-plus'>＋</Text><Text>发布一条信息</Text></View></View></View>
          </View>

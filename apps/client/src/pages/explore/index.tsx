...
export default function ExplorePage() {
  ...
  function openSearch() {
    ...
    if (!value) return notify('输入关键词开始查找');
    notify(`正在查找“${value}”`);
  }
  ...
  return <View className='explore-page'>
    ...
    <View className='explore-search'><Text className='search-icon'>⌕</Text><Input value={keyword} placeholder='搜收购、招工、农机或关键词' onInput={(e) => setKeyword(e.detail.value)} onConfirm={openSearch} /><Text className='search-submit' onClick={openSearch}>↗</Text></View>
